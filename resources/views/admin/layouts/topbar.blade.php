    ...
    <div class="navbar-header">
        ...
        <div class="navbar-logo-box">
            <a href="{{ route('dashboard') }}" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="logo-sm-dark" height="20">
                </span>
                <span class="logo-lg">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="logo-dark" height="40" width="150">
                </span>
            </a>
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn btn-sm top-icon p-0" id="page-header-user-dropdown"
                        ...
                        <img class="rounded avatar-2xs p-0"
                            src="{{ asset('admin/assets/images/users/avatar-6.png') }}" alt="Header Avatar">
                    </button>
