            ...
            <div class="flex items-center justify-between py-4">
                ...
                <div class="flex-1 px-4">
                    <div class="max-w-2xl mx-auto">
                        <div class="relative hidden md:block"> <label for="site-search" class="sr-only">Search</label> <input id="site-search" type="search" placeholder="Search Brands, Products, GTIN's" class="search-focus block w-full pl-4 pr-14 py-3 rounded-full border border-gray-200 shadow-sm placeholder-gray-400 focus:border-violet-500" autocomplete="off" aria-label="Search site" /> <button aria-label="Search" class="absolute right-1 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center rounded-full text-white bg-violet-600 hover:bg-violet-700 focus:outline-none transition-colors"> <i class="fa-solid fa-magnifying-glass text-lg"></i> </button> </div>
                ...
                <div class="flex items-center gap-4">
                    <a href="/wish-list" class="flex items-center gap-2"> <img src="assets/images/wish_list.svg" alt="Wish List" class="h-6"> <span class="hidden sm:inline">Wish List</span> </a>
                    ...
                    <a href="#" id="cart-btn" class="relative flex items-center gap-2">
                        <img src="assets/images/cart.svg" class="h-6">
