            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                <div class="flex items-center gap-3 mb-3 lg:mb-0">
                    <div class="flex items-center gap-2">
                        <button aria-pressed="true" class="p-2 border rounded text-slate-700 bg-white"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                            </svg></button>
                        <button class="p-2 border rounded text-slate-600 bg-white/90"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="lg:flex lg:gap-8">
            ...
            <section class="flex-1">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <!-- Card 1 -->
                    <article class="group relative bg-white border rounded-lg p-4 shadow-sm overflow-hidden">
                        <span class="absolute top-3 left-3 bg-green-100 text-green-700 text-xs font-semibold px-2 py-1 rounded z-10">NEW</span>
                        ...
                        <div class="w-full h-48 flex items-center justify-center mb-4">
                            <img src="assets/images/product02.png" alt="Product 1" class="object-contain max-h-full">
                        </div>


                        <p class="text-sm text-gray-500 mb-1">Cartify</p>
                        <h3 class="text-sm font-semibold text-gray-800 leading-tight mb-2">New Featured MacBook Pro With Apple M1 Pro Chip</h3>
                    ...
                    <article class="group relative bg-white border rounded-lg p-4 shadow-sm overflow-hidden">
                        ...
                        <div class="w-full h-48 flex items-center justify-center mb-4">
                            <img src="assets/images/product03.png" alt="Product 1" class="object-contain max-h-full">
                        </div>
                    ...
                    <article class="group relative bg-white border rounded-lg p-4 shadow-sm overflow-hidden">
                        ...
                        <div class="w-full h-48 flex items-center justify-center mb-4">
                            <img src="assets/images/product04.png" alt="Product 1" class="object-contain max-h-full">
                        </div>
                    ...
                    <article class="group relative bg-white border rounded-lg p-4 shadow-sm overflow-hidden">
                        ...
                        <div class="w-full h-48 flex items-center justify-center mb-4">
                            <img src="assets/images/product003.png" alt="Product 1" class="object-contain max-h-full">
                        </div>
                ...
                <div class="mt-8 flex items-center justify-between">
                    <div class="text-sm text-slate-600">Showing 1-24 of 24 item(s)</div>
                    <div class="flex items-center gap-2">
